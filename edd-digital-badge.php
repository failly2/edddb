	...
	class EDD_Digital_Badge {
		...
		public function settings( $settings ) {
			$new_settings = array(
				...
				array(
					'id'    => 'EDD_Digital_Badge_settingsf',
					'name'  => '<strong>' . __( 'Badge two', 'edd-db-txtt' ) . '</strong>',
					'desc'  => __( 'Configure Plugin Name Settings', 'edd-db-txtt' ),
					'type'  => 'header',
				),
				array(
					'id'    => 'EDD_Digital_Badge_badge_textt',
					'name'  => __( 'Office', 'edd-db-txtt' ),
					'desc'  => __( 'The text string you want to show by products marked as digital', 'edd-db-txtt' ),
					'type'  => 'text',
					'std'   => edd_db_get_badge_string()
				)
			);
